...
-- Insert des prerequis
-- ANGLAIS (chaîne S1 à S6)
INSERT INTO Prerequis VALUES ('ANG_S2','ANG_S1'), ('ANG_S3','ANG_S2'), ('ANG_S4','ANG_S3'), ('ANG_S5','ANG_S4'), ('ANG_S6','ANG_S5');

-- COM PROFESSIONNELLE
INSERT INTO Prerequis VALUES ('COMPRO_S2','COMPRO_S1'), ('COMPRO_S3','COMPRO_S2'), ('COMPRO_S4','COMPRO_S3'), ('COMPRO_S5','COMPRO_S4'), ('COMPRO_S6','COMPRO_S5');

-- ALGORITHMIQUE
INSERT INTO Prerequis VALUES ('ALGO_S2','ALGO_S1'), ('ALGO_S3','ALGO_S2'), ('ALGO_S4','ALGO_S3'), ('ALGO_S5','ALGO_S4'), ('ALGO_S6','ALGO_S5');

-- MATHS DISCRÈTES
INSERT INTO Prerequis VALUES ('MDISC_S2','MDISC_S1'), ('MDISC_S3','MDISC_S2'), ('MDISC_S4','MDISC_S3'), ('MDISC_S5','MDISC_S4'), ('MDISC_S6','MDISC_S5');

-- DROIT CONSTITUTIONNEL
INSERT INTO Prerequis VALUES ('DCONST_S2','DCONST_S1'), ('DCONST_S3','DCONST_S2'), ('DCONST_S4','DCONST_S3'), ('DCONST_S5','DCONST_S4'), ('DCONST_S6','DCONST_S5');

-- HISTOIRE DU DROIT
INSERT INTO Prerequis VALUES ('HDROIT_S2','HDROIT_S1'), ('HDROIT_S3','HDROIT_S2'), ('HDROIT_S4','HDROIT_S3'), ('HDROIT_S5','HDROIT_S4'), ('HDROIT_S6','HDROIT_S5');

-- ÉCONOMIE ET GESTION
INSERT INTO Prerequis VALUES ('ECOG_S2','ECOG_S1'), ('ECOG_S3','ECOG_S2'), ('ECOG_S4','ECOG_S3'), ('ECOG_S5','ECOG_S4'), ('ECOG_S6','ECOG_S5');

-- COMPTABILITÉ
INSERT INTO Prerequis VALUES ('COMP_S2','COMP_S1'), ('COMP_S3','COMP_S2'), ('COMP_S4','COMP_S3'), ('COMP_S5','COMP_S4'), ('COMP_S6','COMP_S5');

-- SYSTÈMES INFO
INSERT INTO Prerequis VALUES ('SINF_S2','SINF_S1'), ('SINF_S3','SINF_S2'), ('SINF_S4','SINF_S3'), ('SINF_S5','SINF_S4'), ('SINF_S6','SINF_S5');

-- RECHERCHE OPÉRATIONNELLE
INSERT INTO Prerequis VALUES ('RECHOP_S2','RECHOP_S1'), ('RECHOP_S3','RECHOP_S2'), ('RECHOP_S4','RECHOP_S3'), ('RECHOP_S5','RECHOP_S4'), ('RECHOP_S6','RECHOP_S5');

-- MODÉLISATION
INSERT INTO Prerequis VALUES ('MODEL_S2','MODEL_S1'), ('MODEL_S3','MODEL_S2'), ('MODEL_S4','MODEL_S3'), ('MODEL_S5','MODEL_S4'), ('MODEL_S6','MODEL_S5');

-- STATS APPLIQUÉES
INSERT INTO Prerequis VALUES ('STATAPP_S2','STATAPP_S1'), ('STATAPP_S3','STATAPP_S2'), ('STATAPP_S4','STATAPP_S3'), ('STATAPP_S5','STATAPP_S4'), ('STATAPP_S6','STATAPP_S5');

-- JAVA AVANCÉ
INSERT INTO Prerequis VALUES ('JAVAPOO_S2','JAVAPOO_S1'), ('JAVAPOO_S3','JAVAPOO_S2'), ('JAVAPOO_S4','JAVAPOO_S3'), ('JAVAPOO_S5','JAVAPOO_S4'), ('JAVAPOO_S6','JAVAPOO_S5');

-- DÉV WEB
INSERT INTO Prerequis VALUES ('DWEB_S2','DWEB_S1'), ('DWEB_S3','DWEB_S2'), ('DWEB_S4','DWEB_S3'), ('DWEB_S5','DWEB_S4'), ('DWEB_S6','DWEB_S5');

-- BASE DE DONNÉES
INSERT INTO Prerequis VALUES ('BDDSQL_S2','BDDSQL_S1'), ('BDDSQL_S3','BDDSQL_S2'), ('BDDSQL_S4','BDDSQL_S3'), ('BDDSQL_S5','BDDSQL_S4'), ('BDDSQL_S6','BDDSQL_S5');

-- GÉNIE LOGICIEL
INSERT INTO Prerequis VALUES ('GLOG_S2','GLOG_S1'), ('GLOG_S3','GLOG_S2'), ('GLOG_S4','GLOG_S3'), ('GLOG_S5','GLOG_S4'), ('GLOG_S6','GLOG_S5');

-- BDD AVANCÉES
INSERT INTO Prerequis VALUES ('BDDADV_S2','BDDADV_S1'), ('BDDADV_S3','BDDADV_S2'), ('BDDADV_S4','BDDADV_S3'), ('BDDADV_S5','BDDADV_S4'), ('BDDADV_S6','BDDADV_S5');

-- BIG DATA
INSERT INTO Prerequis VALUES ('BIGDAT_S2','BIGDAT_S1'), ('BIGDAT_S3','BIGDAT_S2'), ('BIGDAT_S4','BIGDAT_S3'), ('BIGDAT_S5','BIGDAT_S4'), ('BIGDAT_S6','BIGDAT_S5');

-- PYTHON
INSERT INTO Prerequis VALUES ('PYTH_S2','PYTH_S1'), ('PYTH_S3','PYTH_S2'), ('PYTH_S4','PYTH_S3'), ('PYTH_S5','PYTH_S4'), ('PYTH_S6','PYTH_S5');

-- STATS POUR DATA
INSERT INTO Prerequis VALUES ('STATDAT_S2','STATDAT_S1'), ('STATDAT_S3','STATDAT_S2'), ('STATDAT_S4','STATDAT_S3'), ('STATDAT_S5','STATDAT_S4'), ('STATDAT_S6','STATDAT_S5');

-- MACHINE LEARNING
INSERT INTO Prerequis VALUES ('MACHL_S2','MACHL_S1'), ('MACHL_S3','MACHL_S2'), ('MACHL_S4','MACHL_S3'), ('MACHL_S5','MACHL_S4'), ('MACHL_S6','MACHL_S5');

-- DEEP LEARNING
INSERT INTO Prerequis VALUES ('DEEPL_S2','DEEPL_S1'), ('DEEPL_S3','DEEPL_S2'), ('DEEPL_S4','DEEPL_S3'), ('DEEPL_S5','DEEPL_S4'), ('DEEPL_S6','DEEPL_S5');

-- IA ET ÉTHIQUE
INSERT INTO Prerequis VALUES ('IAETH_S2','IAETH_S1'), ('IAETH_S3','IAETH_S2'), ('IAETH_S4','IAETH_S3'), ('IAETH_S5','IAETH_S4'), ('IAETH_S6','IAETH_S5');

-- RÉSEAUX LOCAUX
INSERT INTO Prerequis VALUES ('RESLOC_S2','RESLOC_S1'), ('RESLOC_S3','RESLOC_S2'), ('RESLOC_S4','RESLOC_S3'), ('RESLOC_S5','RESLOC_S4'), ('RESLOC_S6','RESLOC_S5');

-- SÉCURITÉ INFO
INSERT INTO Prerequis VALUES ('SECINFO_S2','SECINFO_S1'), ('SECINFO_S3','SECINFO_S2'), ('SECINFO_S4','SECINFO_S3'), ('SECINFO_S5','SECINFO_S4'), ('SECINFO_S6','SECINFO_S5');

-- ADMIN SYSTÈME
INSERT INTO Prerequis VALUES ('ADMSYS_S2','ADMSYS_S1'), ('ADMSYS_S3','ADMSYS_S2'), ('ADMSYS_S4','ADMSYS_S3'), ('ADMSYS_S5','ADMSYS_S4'), ('ADMSYS_S6','ADMSYS_S5');

-- CLOUD
INSERT INTO Prerequis VALUES ('CLOUD_S2','CLOUD_S1'), ('CLOUD_S3','CLOUD_S2'), ('CLOUD_S4','CLOUD_S3'), ('CLOUD_S5','CLOUD_S4'), ('CLOUD_S6','CLOUD_S5');

-- PROBABILITÉS
INSERT INTO Prerequis VALUES ('PROBA_S2','PROBA_S1'), ('PROBA_S3','PROBA_S2'), ('PROBA_S4','PROBA_S3'), ('PROBA_S5','PROBA_S4'), ('PROBA_S6','PROBA_S5');

-- STATS INFÉRENTIELLES
INSERT INTO Prerequis VALUES ('STATINF_S2','STATINF_S1'), ('STATINF_S3','STATINF_S2'), ('STATINF_S4','STATINF_S3'), ('STATINF_S5','STATINF_S4'), ('STATINF_S6','STATINF_S5');

-- LOGICIEL R
INSERT INTO Prerequis VALUES ('LOGR_S2','LOGR_S1'), ('LOGR_S3','LOGR_S2'), ('LOGR_S4','LOGR_S3'), ('LOGR_S5','LOGR_S4'), ('LOGR_S6','LOGR_S5');

-- THÉORIE SONDAGES
INSERT INTO Prerequis VALUES ('SONDAG_S2','SONDAG_S1'), ('SONDAG_S3','SONDAG_S2'), ('SONDAG_S4','SONDAG_S3'), ('SONDAG_S5','SONDAG_S4'), ('SONDAG_S6','SONDAG_S5');

-- ALGÈBRE LINÉAIRE
INSERT INTO Prerequis VALUES ('ALGLIN_S2','ALGLIN_S1'), ('ALGLIN_S3','ALGLIN_S2'), ('ALGLIN_S4','ALGLIN_S3'), ('ALGLIN_S5','ALGLIN_S4'), ('ALGLIN_S6','ALGLIN_S5');

-- ARITHMÉTIQUE
INSERT INTO Prerequis VALUES ('ARITH_S2','ARITH_S1'), ('ARITH_S3','ARITH_S2'), ('ARITH_S4','ARITH_S3'), ('ARITH_S5','ARITH_S4'), ('ARITH_S6','ARITH_S5');

-- GÉOMÉTRIE
INSERT INTO Prerequis VALUES ('GEOM_S2','GEOM_S1'), ('GEOM_S3','GEOM_S2'), ('GEOM_S4','GEOM_S3'), ('GEOM_S5','GEOM_S4'), ('GEOM_S6','GEOM_S5');

-- TOPOLOGIE
INSERT INTO Prerequis VALUES ('TOPO_S2','TOPO_S1'), ('TOPO_S3','TOPO_S2'), ('TOPO_S4','TOPO_S3'), ('TOPO_S5','TOPO_S4'), ('TOPO_S6','TOPO_S5');

-- ÉQUATIONS DIFFÉRENTIELLES
INSERT INTO Prerequis VALUES ('EQDIF_S2','EQDIF_S1'), ('EQDIF_S3','EQDIF_S2'), ('EQDIF_S4','EQDIF_S3'), ('EQDIF_S5','EQDIF_S4'), ('EQDIF_S6','EQDIF_S5');

-- ANALYSE NUMÉRIQUE
INSERT INTO Prerequis VALUES ('ANANUM_S2','ANANUM_S1'), ('ANANUM_S3','ANANUM_S2'), ('ANANUM_S4','ANANUM_S3'), ('ANANUM_S5','ANANUM_S4'), ('ANANUM_S6','ANANUM_S5');

-- OPTIMISATION
INSERT INTO Prerequis VALUES ('OPTI_S2','OPTI_S1'), ('OPTI_S3','OPTI_S2'), ('OPTI_S4','OPTI_S3'), ('OPTI_S5','OPTI_S4'), ('OPTI_S6','OPTI_S5');

-- DROIT ADMINISTRATIF
INSERT INTO Prerequis VALUES ('DADM_S2','DADM_S1'), ('DADM_S3','DADM_S2'), ('DADM_S4','DADM_S3'), ('DADM_S5','DADM_S4'), ('DADM_S6','DADM_S5');

-- LIBERTÉS PUBLIQUES
INSERT INTO Prerequis VALUES ('LIBPUB_S2','LIBPUB_S1'), ('LIBPUB_S3','LIBPUB_S2'), ('LIBPUB_S4','LIBPUB_S3'), ('LIBPUB_S5','LIBPUB_S4'), ('LIBPUB_S6','LIBPUB_S5');

-- DROIT INTERNATIONAL
INSERT INTO Prerequis VALUES ('DINT_S2','DINT_S1'), ('DINT_S3','DINT_S2'), ('DINT_S4','DINT_S3'), ('DINT_S5','DINT_S4'), ('DINT_S6','DINT_S5');

-- DROIT FISCAL
INSERT INTO Prerequis VALUES ('DFISC_S2','DFISC_S1'), ('DFISC_S3','DFISC_S2'), ('DFISC_S4','DFISC_S3'), ('DFISC_S5','DFISC_S4'), ('DFISC_S6','DFISC_S5');

-- DROIT CIVIL
INSERT INTO Prerequis VALUES ('DCIVIL_S2','DCIVIL_S1'), ('DCIVIL_S3','DCIVIL_S2'), ('DCIVIL_S4','DCIVIL_S3'), ('DCIVIL_S5','DCIVIL_S4'), ('DCIVIL_S6','DCIVIL_S5');

-- DROIT PÉNAL
INSERT INTO Prerequis VALUES ('DPENAL_S2','DPENAL_S1'), ('DPENAL_S3','DPENAL_S2'), ('DPENAL_S4','DPENAL_S3'), ('DPENAL_S5','DPENAL_S4'), ('DPENAL_S6','DPENAL_S5');

-- PROCÉDURE CIVILE
INSERT INTO Prerequis VALUES ('PROCIV_S2','PROCIV_S1'), ('PROCIV_S3','PROCIV_S2'), ('PROCIV_S4','PROCIV_S3'), ('PROCIV_S5','PROCIV_S4'), ('PROCIV_S6','PROCIV_S5');

-- DROIT DE LA FAMILLE
INSERT INTO Prerequis VALUES ('DFAM_S2','DFAM_S1'), ('DFAM_S3','DFAM_S2'), ('DFAM_S4','DFAM_S3'), ('DFAM_S5','DFAM_S4'), ('DFAM_S6','DFAM_S5');

-- DROIT COMMERCIAL
INSERT INTO Prerequis VALUES ('DCOM_S2','DCOM_S1'), ('DCOM_S3','DCOM_S2'), ('DCOM_S4','DCOM_S3'), ('DCOM_S5','DCOM_S4'), ('DCOM_S6','DCOM_S5');

-- DROIT SOCIAL
INSERT INTO Prerequis VALUES ('DSOC_S2','DSOC_S1'), ('DSOC_S3','DSOC_S2'), ('DSOC_S4','DSOC_S3'), ('DSOC_S5','DSOC_S4'), ('DSOC_S6','DSOC_S5');

-- FISCALITÉ ENTREPRISE
INSERT INTO Prerequis VALUES ('FISCEN_S2','FISCEN_S1'), ('FISCEN_S3','FISCEN_S2'), ('FISCEN_S4','FISCEN_S3'), ('FISCEN_S5','FISCEN_S4'), ('FISCEN_S6','FISCEN_S5');

-- DROIT BANCAIRE
INSERT INTO Prerequis VALUES ('DBANQ_S2','DBANQ_S1'), ('DBANQ_S3','DBANQ_S2'), ('DBANQ_S4','DBANQ_S3'), ('DBANQ_S5','DBANQ_S4'), ('DBANQ_S6','DBANQ_S5');
